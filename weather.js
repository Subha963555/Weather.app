const options = {
  method: 'GET',
  headers: {
    'X-RapidAPI-Key': '3341c1cd0cmshea288af40284c48p141ee0jsnfe8cf820ee7c',
...
const tempPur = document.querySelector('#tempPur'); 
...
const getWeather = (city) => {
  ...
  fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Puruliya', options)
    ...
    .then(response => {
      ...
      const sunriseTimePur = new Date(response.sunrise * 1000); 
    ...
    .then(response => {
      ...
      const sunriseTimeBan = new Date(response.sunrise * 1000); 
    ...
    .then(response => {
      ...
      const sunriseTimekol = new Date(response.sunrise * 1000); 
    ...
    .then(response => {
      ...
      const sunriseTimeasa = new Date(response.sunrise * 1000); 
    ...
    fetch('https://weather-by-api-ninjas.p.rapidapi.com/v1/weather?city=Hariyana', options)
    .then(response => response.json())
    .then(response => {
